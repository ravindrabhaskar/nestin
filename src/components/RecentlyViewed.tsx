...
export const RecentlyViewed: React.FC<RecentlyViewedProps> = ({ onSelectProperty, currentPropertyId }) => {
  ...
  return (
    <div className="relative bg-gradient-to-b from-stone-50/60 to-white rounded-3xl border border-slate-200/80 p-5 sm:p-7 shadow-2xs my-8 space-y-4 overflow-hidden">
        ...
        >
          ...
          >
            ...
            <div className="space-y-1.5">
              <h3 className="text-xl font-black font-heading text-slate-900">Recently Viewed Stays</h3>
      ...
      {/* HEADER */}
      <div
        className={`flex items-center justify-between ${!isAuthenticated ? 'filter blur-[3px] select-none pointer-events-none' : ''}`}
      >
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-lg font-black font-heading text-slate-900">Recently Viewed Stays</h3>
