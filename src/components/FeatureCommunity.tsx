...
import { COMMUNITY_POINTS } from '../data/landingData';

const communityImage = 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1200&q=80';

export const FeatureCommunity: React.FC = () => {
  return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        ...
        >
          ...
          <p className="text-slate-500 text-sm sm:text-base leading-relaxed max-w-xl font-medium">
            Our co-living spaces are designed for comfort, connection and convenience.
          </p>

          {/* Bullet List */}
          <div className="space-y-3 pt-2">
            {COMMUNITY_POINTS.map((point, idx) => (
              <motion.div
                key={point}
