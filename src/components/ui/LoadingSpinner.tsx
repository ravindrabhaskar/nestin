        ...
        >
          <svg className="w-full h-full viewBox-0-0-24-24" viewBox="0 0 24 24" fill="none">
            ...
            <path
              ...
              fill="#4285F4"
              d="M12 2a10 10 0 0 1 10 10h-3.5a6.5 6.5 0 0 0-6.5-6.5V2z"
            />
            <path
              className="opacity-100"
              fill="#34A853"
              d="M22 12a10 10 0 0 1-10 10v-3.5a6.5 6.5 0 0 0 6.5-6.5H22z"
            />
            <path
              className="opacity-100"
              fill="#FBBC05"
              d="M12 22A10 10 0 0 1 2 12h3.5a6.5 6.5 0 0 0 6.5 6.5V22z"
            />
            <path
              className="opacity-100"
              fill="#EA4335"
              d="M2 12A10 10 0 0 1 12 2v3.5A6.5 6.5 0 0 0 5.5 12H2z"
            />
          </svg>
        </div>
