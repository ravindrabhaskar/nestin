...
export const WifiAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
  <Icon name="wifi" size={size} className={className} />
);

// 2. Air Conditioning (AC) Split Unit Icon
export const AirConditionerAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
  <Icon name="ac" size={size} className={className} />
);

// 3. Housekeeping / Daily Room Cleaning Icon
export const HousekeepingAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
  <Icon name="housekeeping" size={size} className={className} />
);

// 4. Laundry / Washing Machine Icon
export const LaundryAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
  <Icon name="laundry" size={size} className={className} />
);

// 5. Power Backup Icon
export const PowerBackupAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
  <Icon name="powerBackup" size={size} className={className} />
);

// 6. CCTV Security Camera Icon
export const CctvAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
  <Icon name="cctv" size={size} className={className} />
);

// 7. RO Water / Purified Drinking Water Icon
export const RoWaterAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
  <Icon name="water" size={size} className={className} />
);

// 8. Study & Work Hub Icon
export const StudyWorkAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
  <Icon name="study" size={size} className={className} />
);

// 9. Food & Dining / Meals Icon
export const FoodAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
  <Icon name="food" size={size} className={className} />
);

// 10. Gym & Fitness Hub Icon
export const GymAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
  <Icon name="gym" size={size} className={className} />
);

// 11. Vehicle Parking Icon
export const ParkingAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
  <Icon name="parking" size={size} className={className} />
);

// 12. Television & Entertainment Icon
export const TvAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
  <Icon name="tv" size={size} className={className} />
);

// 13. Hot Water Geyser Icon
export const GeyserAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
  <Icon name="geyser" size={size} className={className} />
);

// 14. Lift / Elevator Icon
export const LiftAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
  <Icon name="lift" size={size} className={className} />
);

// 15. Biometric Smart Entry Icon
export const BiometricAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
  <Icon name="biometric" size={size} className={className} />
);

// 16. Refrigerator Icon
export const RefrigeratorAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
  <Icon name="fridge" size={size} className={className} />
);

// 17. Gaming & Recreation Lounge Icon
export const GamingAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
  <Icon name="gaming" size={size} className={className} />
);

// 18. Cafeteria / Coffee Icon
export const CafeAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
  <Icon name="cafe" size={size} className={className} />
);

// 19. Furnished Bed Icon
export const FurnishedBedAmenityIcon: React.FC<{ className?: string; size?: number }> = ({ className = 'text-current', size = 16 }) => (
...
export const getAmenityIconComponent = (name: string, className = 'text-current', size: number = 14) => {
  ...
  if (lower.includes('food') || lower.includes('meal') || lower.includes('kitchen') || lower.includes('mess') || lower.includes('dining')) {
  ...
  if (lower.includes('tv') || lower.includes('television') || lower.includes('entertainment') || lower.includes('netflix')) {
